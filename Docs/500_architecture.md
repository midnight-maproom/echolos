...
| R4 救出戦ショートカット（[310 §1.13](310_vsprototype_spec.md)） | タイトル画面ボタンから R4 開始の一時ラン状態（手駒・マップ・CurrentRound）を構築／メタ進行は触らず既存進行を温存／エンディング後は通常通り Hub 遷移 | `UseCase.Demo.DemoSaveCatalog` + `DemoSaveDefinition` |
...
| R4 ショートカット用固定セーブ（[310 §1.13](310_vsprototype_spec.md)） | タイトル画面ショートカットボタンから R4 開始の一時ラン状態を構築（メタ進行は触らない） | `UseCase.Demo.DemoSaveCatalog` + `DemoSaveDefinition` |
...
| `Echolos.UseCase.Demo` | R4 ショートカット用固定セーブカタログ（[310 §1.13](310_vsprototype_spec.md)） |
